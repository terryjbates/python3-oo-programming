...
_1to9dict = {'0':'', '1':'one', '2':'two', '3':'three', '4':'four',
             ...
             '9':'nine'}
_10to19dict = {'0':'ten', '1':'eleven', '2':'twelve', '3':
               'thirteen', '4':'fourteen', '5':'fifteen', '6':
               'sixteen', '7':'seventeen', '8':'eighteen', 
               '9':'nineteen'}
...
def num2words(num_string):
    ...
    num_string = '0' + num_string         # pad on left in case it’s a single digit number
